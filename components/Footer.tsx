        ...
        <li>
          <a
            ...
            dangerouslySetInnerHTML={{
              __html: `<ion-icon name="logo-github" />`,
            }}
          ></a>
        </li>
        <li>
          <a
            href={InstagramLink}
            dangerouslySetInnerHTML={{
              __html: `<ion-icon name="logo-instagram" />`,
            }}
          ></a>
        </li>
        <li>
          <a
            href={FacebookLink}
            dangerouslySetInnerHTML={{
              __html: `<ion-icon name="logo-facebook" />`,
            }}
          ></a>
        </li>
        <li>
          <a
            href={YoutubeLink}
            dangerouslySetInnerHTML={{
              __html: `<ion-icon name="logo-youtube" />`,
            }}
          ></a>
        </li>
      </IconList>
      <Copyright>2022, 1000ship</Copyright>
    </Container>
  );
};
